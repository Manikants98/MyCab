...
public class LicenceUpload extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_licence_upload);
        pDialog = new ProgressDialog(this);
        pDialog.setCancelable(false);
        dbs=new SQLiteHandler(this);
        upload=(ImageButton)findViewById(R.id.upload);
        upload.setOnClickListener(this);
        imageView=(ImageView)findViewById(R.id.ivLicense);
    }
    ...
    private void uploadBitmap(final Bitmap bitmap) {
        ...
        pDialog.setMessage("Uploading Licence");
        showDialog();
        //our custom volley request
        VolleyMultipartRequest volleyMultipartRequest = new VolleyMultipartRequest(Request.Method.POST, AppConfig.ROOT_L,
