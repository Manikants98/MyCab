...
public class rc extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView=(ImageView)findViewById(R.id.ivRC);
    }
    ...
    private void uploadBitmap(final Bitmap bitmap) {
        ...
        pDialog.setMessage("Uploading RC");
        showDialog();
        //our custom volley request
        VolleyMultipartRequest volleyMultipartRequest = new VolleyMultipartRequest(Request.Method.POST, AppConfig.ROOT_R,
