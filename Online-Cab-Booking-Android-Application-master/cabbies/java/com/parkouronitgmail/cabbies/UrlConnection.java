...
public class UrlConnection {
    ...
    InputStream getTag(String strurl,String email){
        InputStream is=null;
        try{
            String quaryparams="email="+email;
            URL url =new URL(strurl);
            HttpURLConnection con=(HttpURLConnection)url.openConnection();
            con.setReadTimeout(5000);
            con.setConnectTimeout(5000);
    ...
    InputStream JoinTag(String strurl,String email,String jointag){
        InputStream is=null;
        try{
            String quaryparams="email="+email+"&dawgTag="+jointag;
            URL url =new URL(strurl);
            HttpURLConnection con=(HttpURLConnection)url.openConnection();
            con.setReadTimeout(5000);
            con.setConnectTimeout(5000);
