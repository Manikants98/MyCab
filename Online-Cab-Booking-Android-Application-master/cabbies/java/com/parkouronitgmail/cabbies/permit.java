...
public class permit extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView=(ImageView)findViewById(R.id.ivPermit);
    }
    ...
    private void uploadBitmap(final Bitmap bitmap) {
        ...
        pDialog.setMessage("Uploading Permit");
        showDialog();
        //our custom volley request
        VolleyMultipartRequest volleyMultipartRequest = new VolleyMultipartRequest(Request.Method.POST, AppConfig.ROOT_P,
